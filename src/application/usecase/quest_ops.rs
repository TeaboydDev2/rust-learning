...
use crate::domain::{
    repository::{quest_ops::QuestOpsRepository, quest_viewing::QuestViewingRepository},
...
where
    ...
    T2: QuestViewingRepository + Send + Sync,
{
    pub fn new(quest_ops_respository: Arc<T1>, quest_viewing_repository: Arc<T2>) -> Self {
        Self {
            quest_ops_respository,
